...
CREATE TABLE `assetstwo` (
  ...
  UNIQUE KEY `serialName` (`serialName`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

/*Data for the table `assetstwo` */

insert  into `assetstwo`(`assetsId`,`code`,`serialName`,`supId`,`itmTypeId`,`assetName`,`brand`,`model`,`description`,`unitPrice`,`sellPrice`,`quantity`,`date_purchased`,`endofWarranty_date`,`req_date`,`remarks`,`isDeleted`,`asstId`,`entId`,`catId`,`statId`,`acqTypeId`,`delivery_date`,`deprec_value`,`pr_no`,`req_auth_id`,`req_dep_id`,`est_useful_life`,`isAccount`) values (1,'31231231','1212',7,'3',NULL,NULL,NULL,NULL,'1212',NULL,NULL,'2018-03-15','2018-03-14',NULL,'12asd\r\nasda\r\n',NULL,NULL,NULL,NULL,NULL,NULL,'2018-03-14',NULL,NULL,NULL,NULL,NULL,NULL),(4,'23123','45678192',1,'3',NULL,NULL,NULL,NULL,'129219210',NULL,NULL,'2018-03-07','2018-03-08',NULL,'ASDADA',NULL,NULL,NULL,NULL,NULL,NULL,'2018-03-30',NULL,NULL,NULL,NULL,NULL,NULL),(7,'1212','45678901231',7,'2',NULL,NULL,NULL,NULL,'1231241',NULL,NULL,'2018-03-15','2018-03-14',NULL,'12asd\r\nasda\r\n',NULL,NULL,NULL,NULL,NULL,NULL,'2018-03-14',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `groups` (
  ...
  `groupmodel` varchar(255) DEFAULT NULL,
  `groupbrand` varchar(255) DEFAULT NULL,
  `groupspec` text,
  `sellprice` varchar(255) DEFAULT NULL,
  `critical` int(100) NOT NULL,
...
insert  into `groups`(`groupid`,`groupName`,`groupmodel`,`groupbrand`,`groupspec`,`sellprice`,`critical`,`isDeleted`) values (1,'test','11','11','11\r\n11','100',1,0),(2,'test123333','111','11','11\r\n11','999',1,0),(3,'RAM','HYPERX','ACER','8GB RAM','80',10,0),(4,'RAM 100','9x9','90','9000','200',10,0);
...
insert  into `invoices`(`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`clientAddress`,`bustypeId`,`bustypeName`,`controlNo`,`tin`,`osca_pwd_no`,`sc_tin_no`,`date_created`,`due_date`,`terms`,`remarks`,`vatableSale`,`totalSales`,`vatExemptSale`,`lessVat`,`zeroRatedSale`,`discount`,`vat`,`sales`,`totalAmountDue`,`Status`,`isDeleted`,`salesPerson`) values (13,192929,8,'Mountain Dew',NULL,1,'Computer',NULL,NULL,NULL,NULL,'2018-03-07','2018-03-07',NULL,'121\r\n1212','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',1,0,NULL),(14,4294967295,8,'Mountain Dew',NULL,1,'Computer',NULL,NULL,NULL,NULL,'2018-03-07','2018-03-07',NULL,'1312','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',2,1,NULL);
...
insert  into `items_ordered`(`orderId`,`assetsId`,`assetName`,`quantity`,`unitPrice`,`sellPrice`,`invoiceId`,`handledBy`,`dateadded`,`isDeleted`) values (46,4,'45678192',NULL,129219210,1345,11,NULL,'2018-03-07',0),(47,4,'45678192',NULL,129219210,9000,13,NULL,'2018-03-07',0),(48,4,'45678192',NULL,129219210,2120120,14,NULL,'2018-03-07',0),(49,1,'1212',NULL,1212,160,13,NULL,'2018-04-15',0),(50,4,'45678192',NULL,129219210,160,13,NULL,'2018-04-15',0),(51,7,'45678901231',NULL,1231241,999,13,NULL,'2018-04-15',0),(52,1,'1212',NULL,1212,80,13,NULL,'2018-04-15',0);
...
insert  into `reportsclientorder`(`reportOrder_id`,`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`bustypeId`,`bustypeName`,`total_amount`,`amount_paid`,`handledBy`,`date_paid`,`isDeleted`) values (14,14,2147483647,8,'Mountain Dew',1,'Computer',2374534,3000000,'admin','2018-03-07',0);
...
insert  into `suppliers`(`supId`,`busTypeId`,`supName`,`contactPerson`,`address`,`telno`,`faxno`,`email`,`approved_by`,`date_approved`,`remarks`,`typeOfSup`,`isActive`,`isDeleted`) values (1,2,'Arnold','Ondevilla','mandaluyong city','09500516571','09500950590','float.sundae@gmail.com','','0000-00-00','                   ','Potential',1,0),(7,1,'Sample Supplier','Person 1','Makati City','3938193','210384891839','miguel_ccortez@yahoo.com','Master','2018-01-25','Remark    ','Potential',0,0),(9,4,'as','a','a','a','a','adsas@gmail.com','0','0000-00-00','a          ','Potential',0,0);

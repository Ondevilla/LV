...
{
  $xQx_select = "SELECT * FROM  reportsclientorder WHERE isDeleted='0'";
}
...
<button type="submit" class="btn btn-block btn-info btn-flat " data-toggle="modal" data-target="#'.$ORModal.'">OR &nbsp; <i class="fa fa-print"></i></button>
